...
async def Agent_LLM_API_Call(API, backend_model, conversation, username, bot_name):
    try:
        data = {
            "model": model,
            "messages": conversation
...
async def DB_Prune_API_Call(API, backend_model, conversation, username, bot_name):
    try:
        data = {
            "model": model,
            "messages": conversation
