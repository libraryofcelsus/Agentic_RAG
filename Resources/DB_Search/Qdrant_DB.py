...
def search_db(collection_name, bot_name, user_id, expanded_input, selected_domain, search_number):
    ...
    if all_db_search_results:
        ...
        top_30_results = sorted_results[-search_number:]
...
def retrieve_domain_list(collection_name, bot_name, user_id, expanded_input, search_number):
    timestamp = timestamp_func()
    timestring = timestamp_to_datetime(timestamp)
