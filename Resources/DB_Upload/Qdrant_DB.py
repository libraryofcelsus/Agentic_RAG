...
def upload_document(collection_name, memory_type, bot_name, user_id, text, domain, filename, semantic_db_term):
...
def upload_subagent(collection_name, bot_name, user_id, text, name, filename):
    timestamp = timestamp_func()
    timestring = timestamp_to_datetime(timestamp)
